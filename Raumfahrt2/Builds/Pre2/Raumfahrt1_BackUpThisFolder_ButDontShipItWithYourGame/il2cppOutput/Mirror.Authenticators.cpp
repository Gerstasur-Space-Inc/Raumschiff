...
IL_0055:
	{
		...
		NullCheck(L_15);
		L_15->set_isAuthenticated_4((bool)0);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void BasicAuthenticator_OnAuthResponseMessage_m199D4E787C515075C6FDEB66F20453977FB58826 (BasicAuthenticator_t0D3D92782F1E574906D00856791D051327A2E309 * __this, AuthResponseMessage_tAB2A4012F8D29C41FEE093148E31470EFD93FA00  ___msg0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NetworkAuthenticator_ClientAccept_mE0A35177C44F4DFD7C20B1A48180E75EEA90467C(__this, L_2, /*hidden argument*/NULL);
		// }
		return;
	}
...
IL_0016:
	{
		...
		AuthResponseMessage_tAB2A4012F8D29C41FEE093148E31470EFD93FA00  L_3 = ___msg0;
		String_t* L_4 = L_3.get_message_1();
		String_t* L_5;
		L_5 = String_Concat_m4B4AB72618348C5DFBFBA8DED84B9E2EBDB55E1B(_stringLiteral679A1E0EEED85C2CB3C1ED6DEF6EC36DF15ADEEE, L_4, /*hidden argument*/NULL);
		...
		IL2CPP_RUNTIME_CLASS_INIT(NetworkClient_tF61522EC557C7933F89A0585FE392566A428AE15_il2cpp_TypeInfo_var);
		NetworkConnection_t5DD5A384AFA5946D766F7D3A5F8E5418FAB10311 * L_6;
		L_6 = NetworkClient_get_connection_m5439CD4BADA80C781B783F013464517F581F9557_inline(/*hidden argument*/NULL);
		NetworkAuthenticator_ClientReject_m8FA28F908B17DB620AF67913BD591610BF79B580(__this, L_6, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
{
	{
		...
		NetworkConnection_t5DD5A384AFA5946D766F7D3A5F8E5418FAB10311 * L_1 = ___conn0;
		NullCheck(L_0);
		VirtActionInvoker1< NetworkConnection_t5DD5A384AFA5946D766F7D3A5F8E5418FAB10311 * >::Invoke(9 /* System.Void Mirror.NetworkAuthenticator::OnClientAuthenticate(Mirror.NetworkConnection) */, L_0, L_1);
		// if (timeout > 0)
		float L_2 = __this->get_timeout_7();
		if ((!(((float)L_2) > ((float)(0.0f)))))
		{
...
IL_0038:
	{
		...
		NullCheck(L_7);
		bool L_8 = L_7->get_isAuthenticated_4();
		if (L_8)
		{
			goto IL_0057;
		}
	}
	{
		...
		NullCheck(L_9);
		VirtActionInvoker0::Invoke(5 /* System.Void Mirror.NetworkConnection::Disconnect() */, L_9);
	}
